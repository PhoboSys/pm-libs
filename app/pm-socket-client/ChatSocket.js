...
var _SocketClient2 = require("./SocketClient");
...
var ChatSocket = exports.ChatSocket = /*#__PURE__*/function (_SocketClient) {
  function ChatSocket() {
    _classCallCheck(this, ChatSocket);
    return _callSuper(this, ChatSocket, [{
  ...
  _inherits(ChatSocket, _SocketClient);
  return _createClass(ChatSocket);
}(_SocketClient2.SocketClient);
